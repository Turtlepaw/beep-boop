...
export function BrandColor({
  ...
  return (
    <div
      style={Style}
      className={`${
        isBorder != null ? "border-gray-500 border-[1.3px]" : ""
      } mx-2 flexItem w-40 my-5 px-5 py-5 bord er-gray-500 bor der-2 rounded-lg bg-gray- 500 bg-color-secondary bg-opacity-10`}
    >
      <div>
        <h1 className="font-bold text-lg">{children}</h1>
        <div className="opacity-75 pt-2">{color}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="standardFlexItem forceLargeWidth h-72 mx-5 my-5 px-10 py-5 border-gray-500 border-[1.3px] rounded-lg bg-gray-500 bg-opacity-5">
      ...
      <Center>
        <img
          src={image.png}
          className={`w-32 ${rounded != null ? "rounded-2xl" : ""}`}
        />
      </Center>
      <div className="pt-5">
    ...
    <>
      ...
      <div className="pb-20 pt-5">
        <AutoCenter className="text-center">
          ...
          <p className="pt-2 pb-5 font-medium text-lg max-w-2xl">
            Please do not edit, change, distort, recolor, or reconfigure our
            brand images.
          </p>
          ...
          <Center className="flexContainer">
            ...
            <BrandColor color="#fbb540" textColor="black">
              Canary
            </BrandColor>
            <BrandColor color="#18191c" border>
              Dark Gray
            </BrandColor>
          </Center>
        </AutoCenter>
