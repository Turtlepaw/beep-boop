...
import { Checkmark20Filled, Info16Filled, Info20Filled, Info24Filled } from '@fluentui/react-icons';
    ...
    return (
        <>
            ...
            <Box pb={10}>
                <VStack>
                    <VStack>
                        <Heading style={LighterText} size='sm'>Introducing</Heading>
                        <Heading>
                            <Image style={{ display: "inline-block" }} src='/VerifiedGreen.svg' width={45} />
                            Verified Users
                        </Heading>
                    </VStack>
                    <Text style={LightText}>
                        ...
                        Get verified faster with a <Link isExternal href='/pricing'>pro or basic subscriptions</Link>
                    </Text>
                    <Box pt={2}>
                        <NextLink href="/support">
                            <Button rightIcon={<ExternalIcon />}>
                                Get Verified
                            </Button>
                        </NextLink>
                    </Box>
