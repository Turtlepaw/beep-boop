    ...
    <>
      ...
      <div className="pb-20 pt-5">
        <AutoCenter py={10} className="text-center">
          ...
          <Text maxW={480} pt={0.5} style={LighterText}>
            A strong link between Beep Boop and your Discord account has been
            made. You can now close this tab and continue to Discord!
          </Text>
          <ErrorMessage _stack={{ pt: 1.5 }} _iconColor={yellow} color={yellow}>
            You can always unlink Beep Boop from user settings.
          </ErrorMessage>
        </AutoCenter>
      </div>
    </>
