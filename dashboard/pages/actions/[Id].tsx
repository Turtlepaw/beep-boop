    ...
    <div className="pb-10">
      ...
      <AutoCenter>
        <div className="pb-2">
          ...
          />
          <h2 className="inline pl-2 font-medium text-lg">
            {action.Author.Username}
          </h2>
        </div>
        <h1 className="text-3xl font-semibold">{action.Name}</h1>
        <p className="text-light pt-2 font-medium text-lg">
          {action.Description}
        </p>
        ...
        <AutoCenter className="pt-8">
          <div className="pb-2">
            ...
            >
              <IconContext.Provider value={{ color: "#b9bbbe", size: "20px" }}>
                <Box>
                  <IoInformationCircle />
                </Box>
          ...
          <Codeblock>{action.InternalCode}</Codeblock>
        </AutoCenter>
      </AutoCenter>
    </div>
  );
...
export const getServerSideProps: GetServerSideProps<PageProperties> =
  async function (ctx) {
