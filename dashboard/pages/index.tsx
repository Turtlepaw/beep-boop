    ...
    <div className="pb-10">
      ...
      <AutoCenter>
        <div className="text-center">
          <CustomBadge
            preset={Presets.ComingSoon("!px-4 py-1", "Private Beta")}
          />
          <Center>
            <h1 className="font-bold text-4xl pt-5 pb-1">
              {/* <img src={Configuration.Icon.SVG} className="w-8 inline-block mb-2 mr-2" /> */}
              Modern bot built for the{" "}
              <span style={BrandColor}>21st century</span>
            </h1>
          </Center>
          <Center>
            <p className="max-w-md pt-1 font-medium text-light text-lg">
        ...
        <div>
          <AutoCenter>
            <h1 className="text-center font-bold text-2xl pt-10 max-w-sm">
              Packed with features for your community
            </h1>
          ...
          <div className="FlexContainer">
            <Feature>
              ...
              <FeatureText>
                ...
                <FeatureDescription>
                  Quickly manage your server's settings through the dashboard.
                </FeatureDescription>
              </FeatureText>
            </Feature>
            <Feature>
              ...
              <FeatureText>
                ...
                <FeatureDescription>
                  Let users talk to your mods through a private channel.
                </FeatureDescription>
              </FeatureText>
            </Feature>
            <Feature>
              ...
              <FeatureText>
                ...
                <FeatureDescription>
                  Give users a second chance with in-app appeals.
                </FeatureDescription>
              </FeatureText>
            </Feature>
            <Feature>
              ...
              <FeatureText>
                ...
                <FeatureDescription>
                  Reward your members for being active with levels.
                </FeatureDescription>
              </FeatureText>
            </Feature>
            <Feature>
              ...
              <FeatureText>
                ...
                <FeatureDescription>
                  Create advanced giveaways with tons of requirements.
                </FeatureDescription>
              </FeatureText>
            </Feature>
          </div>
