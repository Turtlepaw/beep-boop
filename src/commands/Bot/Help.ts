...
export default class Help extends SlashCommandBuilder {
  ...
  async ExecuteAutocompleteRequest(
    ...
    interaction.respond([...FilteredCommands]);
  }
  ...
  async ExecuteCommand(
    ...
    const CategoryDescriptions = {
      Server:
        "Server configuration, moderation, other server-related commands.",
    ...
    if (CommandId == null) {
      const AllCommands = client.DetailedCommands.map((APICommand) => {
        ...
        return {
          ...
          Description:
            SlashCommand?.Description || "This command has no description.",
      ...
      const Command: SlashCommandBuilder | ContextMenuBuilder =
      ...
      interaction.reply({
        ...
        embeds: [
          new Embed(interaction)
            ...
            .setDescription(
              (Command as SlashCommandBuilder)?.Description ||
